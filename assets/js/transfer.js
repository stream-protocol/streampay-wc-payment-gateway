...
jQuery(function($) {
    ...
    async function transferSOL(provider) {
        ...
        if (publicKey) {
            try {
                ...
                var receiverWallet = new solanaWeb3.PublicKey(storeWalletAddress);
                ...
                // Construct USDC, SOL, SPL token class
                ...
                // Create associated Stream Token accounts for my token if they don't exist yet
                ...
                $.ajax({
                    url: wpstreamApi.root + 'strea,-api/v1/check_payment',
                    method: 'POST',
    ...
    $(document.body).on('click', '.pay_browser_button.sol', async function() {
        ...
        // Detecting and storing the Solfare wallet of the user (creator in this case)
