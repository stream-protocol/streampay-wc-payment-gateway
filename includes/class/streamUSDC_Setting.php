...
class streamUSDC_Setting {
    ...
    public function __construct()
    {
        ...
        if (function_exists('WC')) {
            ...
            if(!empty($payment_gateways) && !empty($payment_gateways[STREAM_PAY_DOMAIN]))
            {
                $payment_gateway = $payment_gateways[STREAM_PAY_DOMAIN];
                $this->settings = array(
...
//        /**
//         * Validate the Wallet address for SOL/USDC
//         */
//
