...
/**
 * Stream Payment Gateway core component
 * @ver 1.0
 */
...
class stream_component{
    ...
    /**
     * StreamPay Payment Gateway version.
     *
     * @var string
     */
    ...
    /**
     * Instance of Stream Payment Gateway Component View template rendered.
     *
     * @since 1.0.0
     * @var stream
     */
    ...
    public static function load_file( $file, $folder, $args = [] ) {
        $full_path = STREAM_PAY_PLUGIN_DIR .'/includes/'.$folder . '/' . $file;
        /**
    ...
    /**
     * Create a new instance of the $class, which is stored in $file in the $folder sub folder
