...
<div class="main_body">
    <div class="content__pair">
        ...
        <div class="content__pair--narr">
            ...
            <div class="stream_qr">
                <img src="<?php echo STREAM_PAY_PLUGIN_URL.'/assets/images/tmp_stream_qrcode.png';?>">
            </div>
        </div>
    </div>
    <div class="content__pair">
    ...
    <div class="content__pair">
        ...
        <div class="content__pair--content">
            ...
            <div class="content__pair--subcontent">
                ...
                <img src="<?php echo STREAM_PAY_PLUGIN_URL.'/assets/images/payment_processing_animation.gif';?>">
                </div>
            </div>
            <div class="content__pair--subheader">
        ...
        <div class="content__pair--content">
            <div class="content__pair--subheader">
                <a class="app_broswer_link apple" href="https://apps.apple.com/us/genre/ios/id36">
                    <img width="150" src="<?php echo STREAM_PAY_PLUGIN_URL.'/assets/images/apple-app-store.png';?>">
                </a>
            </div>
...
<div id="streammodal" class="stream_modal">
    ...
    <div class="modal-content">
        ...
        <div class="processing_image">
            <img width="100" src="<?php echo STREAM_PAY_PLUGIN_URL.'/assets/images/payment_confirmation_animation.gif';?>">
        </div>
