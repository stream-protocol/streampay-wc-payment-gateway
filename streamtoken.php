 ...
 *
 * @wordpress-plugin
 * Plugin Name:       StreamPay USDC/SOL Payment Gateway
 * Plugin URI:        https://streamprotocol.org
 * Description:       Add the USDC, SOL, SPL token in WooCommerce, making use of Phantom and SolFare for decentralized commerce.
 * Version:           1.0.0
 * Author:            Stream Protocol Ltd.
...
if ( ! defined( 'STEAM_PAY_PLUGIN_FILE' ) ) {
    define( 'STREAM_PAY_PLUGIN_FILE', __FILE__ );
}
...
define('stream_ABS_PATH', dirname(STREAM_PAY_PLUGIN_FILE));
define('stream_Payment_PROCESS', 'Finalize Order');
